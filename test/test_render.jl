...
@testset "Styles" begin
    ...
    @testset "Turn, SimpleTrace" begin
        ...
        c = Cell("main", nm)
        pa = Path(μm)
        turn!(pa, π, 4000µm, Paths.Trace(10µm))
        render!(c, pa)
    ...
    @testset "Turn, SimpleCPW" begin
        ...
        # rand_factor=0 disables MersenneTwister
        render!(c, pa, grid_step=500.0, max_change=90°, rand_factor=0)
        @test points(c.elements[1]) == Point{Float64}[
            p(0.0, 5.0),
            p(17.220754456429038, 8.425421036992095),
            p(31.819805153394633, 18.18019484660536),
            p(41.57457896300791, 32.77924554357096),
            p(45.0, 50.0),
            p(39.0, 50.0),
            p(36.031301767940185, 35.0753461377615),
            p(27.57716446627535, 22.422835533724644),
            p(14.9246538622385, 13.968698232059817),
            p(0.0, 11.0)
        ]
        @test points(c.elements[2]) == Point{Float64}[
            p(0.0, -11.0),
            p(23.343689374270475, -6.356651483188495),
            p(43.13351365237939, 6.866486347620599),
            p(56.35665148318849, 26.65631062572952),
            p(61.0, 50.0),
            p(55.0, 50.0),
            p(50.81337428812077, 28.95241121992006),
            p(38.89087296526011, 11.109127034739885),
            p(21.047588780079938, -0.8133742881207731),
            p(0.0, -5.0)
        ]
        ...
        # rand_factor=0 disables MersenneTwister
        render!(c, pa, grid_step=500.0μm, max_change=90°, rand_factor=0)
        @test points(c.elements[1]) == Point{typeof(1.0nm)}[
            p(0.0nm, 5000.0nm),
            p(17220.754456429037nm, 8425.421036992095nm),
            p(31819.80515339463nm, 18180.19484660536nm),
            p(41574.57896300791nm, 32779.245543570956nm),
            p(45000.0nm, 50000.0nm),
            p(39000.0nm, 50000.0nm),
            p(36031.30176794018nm, 35075.3461377615nm),
            p(27577.16446627535nm, 22422.835533724643nm),
            p(14924.6538622385nm, 13968.698232059816nm),
            p(0.0nm, 11000.0nm)
        ]
        @test points(c.elements[2]) == Point{typeof(1.0nm)}[
            p(0.0nm, -11000.0nm),
            p(23343.689374270474nm, -6356.651483188495nm),
            p(43133.51365237939nm, 6866.486347620599nm),
            p(56356.65148318849nm, 26656.310625729522nm),
            p(61000.0nm, 50000.0nm),
            p(55000.0nm, 50000.0nm),
            p(50813.37428812077nm, 28952.411219920057nm),
            p(38890.87296526011nm, 11109.127034739884nm),
            p(21047.58878007994nm, -813.374288120773nm),
            p(0.0nm, -5000.0nm)
        ]
